  ...
  <section class="completed-tasks">
    ...
    <div class="content-wrapper">
      <router-link to="/PageRydalsHerrgard" class="content">
        <ContentItem>
          <template #icon>
            <img src="/images/rydals_herrgard/rydals_herrgard.webp" alt="Rydals Herrgård" width="125" height="125" />
          </template>
      ...
      <router-link to="/PageRankhyttan" class="content">
        <ContentItem>
          <template #icon>
            <img src="/images/rankhyttan/rankhyttan.webp" alt="Rankhyttans Herrgård" width="125" height="125" />
          </template>
      ...
      <router-link to="/PageGathenhielmskaHuset" class="content">
        <ContentItem>
          <template #icon>
            <img src="/images/gathenhielmska_huset/Gathenhielmska_huset.webp" alt="Gathenhielmska Huset" width="125" height="125" />
          </template>
      ...
      <router-link to="/PageHemsoktaMuseet" class="content">
        <ContentItem>
          <template #icon>
            <img src="/images/hemsokta_museet/Hemsokta_museet.webp" alt="Hemsökta museet" width="125" height="125" />
          </template>
      ...
      <router-link to="/PageHjortsberga" class="content">
        <ContentItem>
          <template #icon>
            <img src="/images/hjortsberga/Hjortsberga.webp" alt="Hjortsberga Prästgård" width="125" height="125" />
          </template>
      ...
      <router-link to="/PageFrammegarden" class="content">
        <ContentItem>
          <template #icon>
            <img src="/images/frammegarden/Frammegarden.webp" alt="Frammegården" width="125" height="125" />
          </template>
