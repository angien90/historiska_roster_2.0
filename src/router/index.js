...
const routes = [
  ...
  { path: "/askhults-by", name: "AskhultsBy", component: () => import("../views/PageAskhultsBy.vue") },
  { path: "/borgvattnet", name: "Borgvattnet", component: () => import("../views/PageBorgvattnet.vue") }
];
